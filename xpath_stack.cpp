...
class result_and_next : public expression_result
{
  public:
  /// Constructor
  result_and_next (expression_result er_in, result_and_next* rnp_in_next) : expression_result (er_in) { rnp_next = rnp_in_next; }
  /// Return next element
  result_and_next* rnp_get_next () { return rnp_next; }
...
void result_and_next::v_dump () { expression_result::v_dump (); }
#endif
...
expression_result* xpath_stack::erp_previous (unsigned u_nb)   ///< Nb of items to skip.
{
