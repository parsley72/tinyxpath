...
class lex_token
{
  ...
  void v_set_next (lex_token* ltp_in_next) { ltp_next = ltp_in_next; }
  /// set the previous element in list
  void v_set_prev (lex_token* ltp_in_prev) { ltp_prev = ltp_in_prev; }
  ...
  /// get next in list
  lex_token* ltp_get_next () const { return ltp_next; }

  /// get next in list
  lex_token* ltp_get_prev () const { return ltp_prev; }
  ...
  lexico lex_get_value () const { return l_enum; }
  ...
  const char* cp_get_literal () { return cp_value; }
