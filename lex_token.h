...
class lex_token
{
  ...
  void v_set_next (lex_token* ltp_in_next) { _ltp_next = ltp_in_next; }
  /// set the previous element in list
  void v_set_prev (lex_token* ltp_in_prev) { _ltp_prev = ltp_in_prev; }
  ...
  /// get next in list
  lex_token* ltp_get_next () const { return _ltp_next; }

  /// get next in list
  lex_token* ltp_get_prev () const { return _ltp_prev; }
  ...
  lexico lex_get_value () const { return _l_enum; }
  ...
  const char* cp_get_literal () { return _cp_value; }

  /// check if the lexical element is valid
  bool o_is_valid () const { return (_l_enum != lex_null); }
};
