...
class token_list
{
  ...
  void v_set_current_top () { _ltp_current = _ltp_first->ltp_get_next (1); }

  /// Set current
  void v_set_current (lex_token* ltp_cur) { _ltp_current = ltp_cur; }

  /// Return the current token
  lex_token* ltp_freeze () { return _ltp_current; }
