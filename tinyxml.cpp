...
void TiXmlElement::SetAttribute (const char* cname, const char* cvalue)
{
  ...
  else
  {
    TiXmlDocument* document = GetDocument ();
    if (document)
      document->SetError (TIXML_ERROR_OUT_OF_MEMORY, nullptr, nullptr, TIXML_ENCODING_UNKNOWN);
  }
}
...
TiXmlComment::TiXmlComment (const TiXmlComment& copy) : TiXmlNode (TiXmlNode::COMMENT) { copy.CopyTo (this); }
...
TiXmlDeclaration::TiXmlDeclaration (const TiXmlDeclaration& copy) : TiXmlNode (TiXmlNode::DECLARATION) { copy.CopyTo (this); }
