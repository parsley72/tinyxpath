...
class action_item
{
  public:
  /// constructor
  action_item (int i_in_1, int i_in_2, int i_in_3, const char* cp_string) : _i_1 (i_in_1), _i_2 (i_in_2), _i_3 (i_in_3), _S_string (cp_string) { }
...
class action_store
{
  ...
  int i_get_position () { return _i_position; }
  /// Set the position to an arbitrary value. See _i_position.
  void v_set_position (int i_where) { _i_position = i_where; }
  /// Decrement the position. See _i_position.
  void v_dec_position () { _i_position--; }
  protected:
